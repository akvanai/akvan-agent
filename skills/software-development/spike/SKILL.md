...
version: 1.0.0
author: Akvan Agent (adapted from gsd-build/get-shit-done)
license: MIT
...
Use Akvan tools for the research step:
...
**Parallel comparison spikes (002a / 002b).** When two approaches need real engineering (not 10-line prototypes), build them sequentially in separate spike directories (`spikes/002a-...`, `spikes/002b-...`), then compare verdicts head-to-head.
