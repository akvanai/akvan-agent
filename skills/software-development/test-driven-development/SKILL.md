...
Akvan does not have subagent delegation. When implementing larger features, follow strict TDD yourself task-by-task: write the failing test, verify red, implement minimally, verify green, then commit before moving on.
