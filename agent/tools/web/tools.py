...
WEB_EXTRACT_DESCRIPTION = (
    ...
    "Also works with PDF URLs — pass the PDF link directly and it converts to "
    "markdown text. Pages under 5000 chars return full markdown; larger pages "
            ...
            return json.dumps(
                {
                    ...
                    "error": (
                        ...
                        "to firecrawl and configure FIRECRAWL_API_URL."
                    ),
                },
                ensure_ascii=False,
                indent=2,
            ...
            return json.dumps(
                {
                    ...
                    "error": (
                        ...
                        "Run `akvan tools` and configure Firecrawl self-hosted."
                    ),
                },
                ensure_ascii=False,
                indent=2,
